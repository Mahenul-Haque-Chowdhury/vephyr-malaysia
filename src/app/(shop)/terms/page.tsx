  ...
  return (
    <main className="min-h-screen pt-32 px-6 md:px-12 bg-alabaster">
      <div className="max-w-3xl mx-auto space-y-8 animate-fade-in-slow">
        <h1 className="font-sans text-3xl tracking-wide mb-12">TERMS & CONDITIONS</h1>
        
        <div className="font-mono text-xs leading-relaxed space-y-6 text-charcoal/70">
          ...
          <h2 className="text-charcoal pt-4 tracking-widest">2. INTELLECTUAL PROPERTY</h2>
          <p>
          ...
          <p>
            We accept the following forms of payment: Visa, Mastercard, American Express, PayPal. 
